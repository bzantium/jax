...
class TCGen05RaceDetectionTest(jtu.JaxTestCase):
  ...
  def test_cross_thread_mmas_pipelined(self):
    @functools.partial(
        plgpu.kernel,
        out_type=jax.ShapeDtypeStruct(ACC_SHAPE, jnp.float32),
        scratch_types=dict(
  ...
  def test_cross_thread_mma_pipeline_multiparent_has_race(self):
    @functools.partial(
        plgpu.kernel,
        out_type=jax.ShapeDtypeStruct(ACC_SHAPE, jnp.float32),
        scratch_types=dict(
  ...
  def test_cross_thread_handoff_requires_producer_wait(
      self, producer_op, producer_waits, consumer_waits
  ):
  ...
  def test_commit_arrive_does_not_cover_other_threads_mma(self):
  ...
  def test_cross_thread_copy_then_mma_is_pipelined(self):
  ...
  def test_mma_barrier_wait_synchronizes_consumer_thread(self):
  ...
  def test_can_pipeline_with_multiple_parents(self):
    @functools.partial(
        plgpu.kernel,
        out_type=jax.ShapeDtypeStruct(ACC_SHAPE, jnp.float32),
        scratch_types=dict(
